 ...
 * @see MPU60X0.DEFAULT_ADDRESS
 */
function MPU60X0(address) {
    this.address = address || MPU60X0.DEFAULT_ADDRESS;
}
    
MPU60X0.ADDRESS_AD0_LOW               = 0x68; // address pin low (GND); default for InvenSense evaluation board
MPU60X0.ADDRESS_AD0_HIGH              = 0x69; // address pin high (VCC)
MPU60X0.DEFAULT_ADDRESS               = 0x68; // (TODO:jms ?? << 1;

MPU60X0.RA_XG_OFFS_TC                 = 0x00; //[7] PWR_MODE; [6        =1] XG_OFFS_TC; [0] OTP_BNK_VLD
MPU60X0.RA_YG_OFFS_TC                 = 0x01; //[7] PWR_MODE; [6        =1] YG_OFFS_TC; [0] OTP_BNK_VLD
MPU60X0.RA_ZG_OFFS_TC                 = 0x02; //[7] PWR_MODE; [6        =1] ZG_OFFS_TC; [0] OTP_BNK_VLD
MPU60X0.RA_X_FINE_GAIN                = 0x03; //[7        =0] X_FINE_GAIN
MPU60X0.RA_Y_FINE_GAIN                = 0x04; //[7        =0] Y_FINE_GAIN
MPU60X0.RA_Z_FINE_GAIN                = 0x05; //[7        =0] Z_FINE_GAIN
MPU60X0.RA_XA_OFFS_H                  = 0x06; //[15        =0] XA_OFFS
MPU60X0.RA_XA_OFFS_L_TC               = 0x07;
MPU60X0.RA_YA_OFFS_H                  = 0x08; //[15        =0] YA_OFFS
MPU60X0.RA_YA_OFFS_L_TC               = 0x09;
MPU60X0.RA_ZA_OFFS_H                  = 0x0A; //[15        =0] ZA_OFFS
MPU60X0.RA_ZA_OFFS_L_TC               = 0x0B;
MPU60X0.RA_XG_OFFS_USRH               = 0x13; //[15        =0] XG_OFFS_USR
MPU60X0.RA_XG_OFFS_USRL               = 0x14;
MPU60X0.RA_YG_OFFS_USRH               = 0x15; //[15        =0] YG_OFFS_USR
MPU60X0.RA_YG_OFFS_USRL               = 0x16;
MPU60X0.RA_ZG_OFFS_USRH               = 0x17; //[15        =0] ZG_OFFS_USR
MPU60X0.RA_ZG_OFFS_USRL               = 0x18;
MPU60X0.RA_SMPLRT_DIV                 = 0x19;
MPU60X0.RA_CONFIG                     = 0x1A;
MPU60X0.RA_GYRO_CONFIG                = 0x1B;
MPU60X0.RA_ACCEL_CONFIG               = 0x1C;
MPU60X0.RA_FF_THR                     = 0x1D;
MPU60X0.RA_FF_DUR                     = 0x1E;
MPU60X0.RA_MOT_THR                    = 0x1F;
MPU60X0.RA_MOT_DUR                    = 0x20;
MPU60X0.RA_ZRMOT_THR                  = 0x21;
MPU60X0.RA_ZRMOT_DUR                  = 0x22;
MPU60X0.RA_FIFO_EN                    = 0x23;
MPU60X0.RA_I2C_MST_CTRL               = 0x24;
MPU60X0.RA_I2C_SLV0_ADDR              = 0x25;
MPU60X0.RA_I2C_SLV0_REG               = 0x26;
MPU60X0.RA_I2C_SLV0_CTRL              = 0x27;
MPU60X0.RA_I2C_SLV1_ADDR              = 0x28;
MPU60X0.RA_I2C_SLV1_REG               = 0x29;
MPU60X0.RA_I2C_SLV1_CTRL              = 0x2A;
MPU60X0.RA_I2C_SLV2_ADDR              = 0x2B;
MPU60X0.RA_I2C_SLV2_REG               = 0x2C;
MPU60X0.RA_I2C_SLV2_CTRL              = 0x2D;
MPU60X0.RA_I2C_SLV3_ADDR              = 0x2E;
MPU60X0.RA_I2C_SLV3_REG               = 0x2F;
MPU60X0.RA_I2C_SLV3_CTRL              = 0x30;
MPU60X0.RA_I2C_SLV4_ADDR              = 0x31;
MPU60X0.RA_I2C_SLV4_REG               = 0x32;
MPU60X0.RA_I2C_SLV4_DO                = 0x33;
MPU60X0.RA_I2C_SLV4_CTRL              = 0x34;
MPU60X0.RA_I2C_SLV4_DI                = 0x35;
MPU60X0.RA_I2C_MST_STATUS             = 0x36;
MPU60X0.RA_INT_PIN_CFG                = 0x37;
MPU60X0.RA_INT_ENABLE                 = 0x38;
MPU60X0.RA_DMP_INT_STATUS             = 0x39;
MPU60X0.RA_INT_STATUS                 = 0x3A;
MPU60X0.RA_ACCEL_XOUT_H               = 0x3B;
MPU60X0.RA_ACCEL_XOUT_L               = 0x3C;
MPU60X0.RA_ACCEL_YOUT_H               = 0x3D;
MPU60X0.RA_ACCEL_YOUT_L               = 0x3E;
MPU60X0.RA_ACCEL_ZOUT_H               = 0x3F;
MPU60X0.RA_ACCEL_ZOUT_L               = 0x40;
MPU60X0.RA_TEMP_OUT_H                 = 0x41;
MPU60X0.RA_TEMP_OUT_L                 = 0x42;
MPU60X0.RA_GYRO_XOUT_H                = 0x43;
MPU60X0.RA_GYRO_XOUT_L                = 0x44;
MPU60X0.RA_GYRO_YOUT_H                = 0x45;
MPU60X0.RA_GYRO_YOUT_L                = 0x46;
MPU60X0.RA_GYRO_ZOUT_H                = 0x47;
MPU60X0.RA_GYRO_ZOUT_L                = 0x48;
MPU60X0.RA_EXT_SENS_DATA_00           = 0x49;
MPU60X0.RA_EXT_SENS_DATA_01           = 0x4A;
MPU60X0.RA_EXT_SENS_DATA_02           = 0x4B;
MPU60X0.RA_EXT_SENS_DATA_03           = 0x4C;
MPU60X0.RA_EXT_SENS_DATA_04           = 0x4D;
MPU60X0.RA_EXT_SENS_DATA_05           = 0x4E;
MPU60X0.RA_EXT_SENS_DATA_06           = 0x4F;
MPU60X0.RA_EXT_SENS_DATA_07           = 0x50;
MPU60X0.RA_EXT_SENS_DATA_08           = 0x51;
MPU60X0.RA_EXT_SENS_DATA_09           = 0x52;
MPU60X0.RA_EXT_SENS_DATA_10           = 0x53;
MPU60X0.RA_EXT_SENS_DATA_11           = 0x54;
MPU60X0.RA_EXT_SENS_DATA_12           = 0x55;
MPU60X0.RA_EXT_SENS_DATA_13           = 0x56;
MPU60X0.RA_EXT_SENS_DATA_14           = 0x57;
MPU60X0.RA_EXT_SENS_DATA_15           = 0x58;
MPU60X0.RA_EXT_SENS_DATA_16           = 0x59;
MPU60X0.RA_EXT_SENS_DATA_17           = 0x5A;
MPU60X0.RA_EXT_SENS_DATA_18           = 0x5B;
MPU60X0.RA_EXT_SENS_DATA_19           = 0x5C;
MPU60X0.RA_EXT_SENS_DATA_20           = 0x5D;
MPU60X0.RA_EXT_SENS_DATA_21           = 0x5E;
MPU60X0.RA_EXT_SENS_DATA_22           = 0x5F;
MPU60X0.RA_EXT_SENS_DATA_23           = 0x60;
MPU60X0.RA_MOT_DETECT_STATUS          = 0x61;
MPU60X0.RA_I2C_SLV0_DO                = 0x63;
MPU60X0.RA_I2C_SLV1_DO                = 0x64;
MPU60X0.RA_I2C_SLV2_DO                = 0x65;
MPU60X0.RA_I2C_SLV3_DO                = 0x66;
MPU60X0.RA_I2C_MST_DELAY_CTRL         = 0x67;
MPU60X0.RA_SIGNAL_PATH_RESET          = 0x68;
MPU60X0.RA_MOT_DETECT_CTRL            = 0x69;
MPU60X0.RA_USER_CTRL                  = 0x6A;
MPU60X0.RA_PWR_MGMT_1                 = 0x6B;
MPU60X0.RA_PWR_MGMT_2                 = 0x6C;
MPU60X0.RA_BANK_SEL                   = 0x6D;
MPU60X0.RA_MEM_START_ADDR             = 0x6E;
MPU60X0.RA_MEM_R_W                    = 0x6F;
MPU60X0.RA_DMP_CFG_1                  = 0x70;
MPU60X0.RA_DMP_CFG_2                  = 0x71;
MPU60X0.RA_FIFO_COUNTH                = 0x72;
MPU60X0.RA_FIFO_COUNTL                = 0x73;
MPU60X0.RA_FIFO_R_W                   = 0x74;
MPU60X0.RA_WHO_AM_I                   = 0x75;

MPU60X0.TC_PWR_MODE_BIT               = 7;
MPU60X0.TC_OFFSET_BIT                 = 6;
MPU60X0.TC_OFFSET_LENGTH              = 6;
MPU60X0.TC_OTP_BNK_VLD_BIT            = 0;

MPU60X0.VDDIO_LEVEL_VLOGIC            = 0;
MPU60X0.VDDIO_LEVEL_VDD               = 1;

MPU60X0.CFG_EXT_SYNC_SET_BIT          = 5;
MPU60X0.CFG_EXT_SYNC_SET_LENGTH       = 3;
MPU60X0.CFG_DLPF_CFG_BIT              = 2;
MPU60X0.CFG_DLPF_CFG_LENGTH           = 3;

MPU60X0.EXT_SYNC_DISABLED             = 0x0;
MPU60X0.EXT_SYNC_TEMP_OUT_L           = 0x1;
MPU60X0.EXT_SYNC_GYRO_XOUT_L          = 0x2;
MPU60X0.EXT_SYNC_GYRO_YOUT_L          = 0x3;
MPU60X0.EXT_SYNC_GYRO_ZOUT_L          = 0x4;
MPU60X0.EXT_SYNC_ACCEL_XOUT_L         = 0x5;
MPU60X0.EXT_SYNC_ACCEL_YOUT_L         = 0x6;
MPU60X0.EXT_SYNC_ACCEL_ZOUT_L         = 0x7;

MPU60X0.DLPF_BW_256                   = 0x00;
MPU60X0.DLPF_BW_188                   = 0x01;
MPU60X0.DLPF_BW_98                    = 0x02;
MPU60X0.DLPF_BW_42                    = 0x03;
MPU60X0.DLPF_BW_20                    = 0x04;
MPU60X0.DLPF_BW_10                    = 0x05;
MPU60X0.DLPF_BW_5                     = 0x06;

MPU60X0.GCONFIG_FS_SEL_BIT            = 4;
MPU60X0.GCONFIG_FS_SEL_LENGTH         = 2;

MPU60X0.GYRO_FS_250                   = 0x00;
MPU60X0.GYRO_FS_500                   = 0x01;
MPU60X0.GYRO_FS_1000                  = 0x02;
MPU60X0.GYRO_FS_2000                  = 0x03;

MPU60X0.ACONFIG_XA_ST_BIT             = 7;
MPU60X0.ACONFIG_YA_ST_BIT             = 6;
MPU60X0.ACONFIG_ZA_ST_BIT             = 5;
MPU60X0.ACONFIG_AFS_SEL_BIT           = 4;
MPU60X0.ACONFIG_AFS_SEL_LENGTH        = 2;
MPU60X0.ACONFIG_ACCEL_HPF_BIT         = 2;
MPU60X0.ACONFIG_ACCEL_HPF_LENGTH      = 3;

MPU60X0.ACCEL_FS_2                    = 0x00;
MPU60X0.ACCEL_FS_4                    = 0x01;
MPU60X0.ACCEL_FS_8                    = 0x02;
MPU60X0.ACCEL_FS_16                   = 0x03;

MPU60X0.DHPF_RESET                    = 0x00;
MPU60X0.DHPF_5                        = 0x01;
MPU60X0.DHPF_2P5                      = 0x02;
MPU60X0.DHPF_1P25                     = 0x03;
MPU60X0.DHPF_0P63                     = 0x04;
MPU60X0.DHPF_HOLD                     = 0x07;

MPU60X0.TEMP_FIFO_EN_BIT              = 7;
MPU60X0.XG_FIFO_EN_BIT                = 6;
MPU60X0.YG_FIFO_EN_BIT                = 5;
MPU60X0.ZG_FIFO_EN_BIT                = 4;
MPU60X0.ACCEL_FIFO_EN_BIT             = 3;
MPU60X0.SLV2_FIFO_EN_BIT              = 2;
MPU60X0.SLV1_FIFO_EN_BIT              = 1;
MPU60X0.SLV0_FIFO_EN_BIT              = 0;

MPU60X0.MULT_MST_EN_BIT               = 7;
MPU60X0.WAIT_FOR_ES_BIT               = 6;
MPU60X0.SLV_3_FIFO_EN_BIT             = 5;
MPU60X0.I2C_MST_P_NSR_BIT             = 4;
MPU60X0.I2C_MST_CLK_BIT               = 3;
MPU60X0.I2C_MST_CLK_LENGTH            = 4;

MPU60X0.CLOCK_DIV_348                 = 0x0;
MPU60X0.CLOCK_DIV_333                 = 0x1;
MPU60X0.CLOCK_DIV_320                 = 0x2;
MPU60X0.CLOCK_DIV_308                 = 0x3;
MPU60X0.CLOCK_DIV_296                 = 0x4;
MPU60X0.CLOCK_DIV_286                 = 0x5;
MPU60X0.CLOCK_DIV_276                 = 0x6;
MPU60X0.CLOCK_DIV_267                 = 0x7;
MPU60X0.CLOCK_DIV_258                 = 0x8;
MPU60X0.CLOCK_DIV_500                 = 0x9;
MPU60X0.CLOCK_DIV_471                 = 0xA;
MPU60X0.CLOCK_DIV_444                 = 0xB;
MPU60X0.CLOCK_DIV_421                 = 0xC;
MPU60X0.CLOCK_DIV_400                 = 0xD;
MPU60X0.CLOCK_DIV_381                 = 0xE;
MPU60X0.CLOCK_DIV_364                 = 0xF;

MPU60X0.I2C_SLV_RW_BIT                = 7;
MPU60X0.I2C_SLV_ADDR_BIT              = 6;
MPU60X0.I2C_SLV_ADDR_LENGTH           = 7;
MPU60X0.I2C_SLV_EN_BIT                = 7;
MPU60X0.I2C_SLV_BYTE_SW_BIT           = 6;
MPU60X0.I2C_SLV_REG_DIS_BIT           = 5;
MPU60X0.I2C_SLV_GRP_BIT               = 4;
MPU60X0.I2C_SLV_LEN_BIT               = 3;
MPU60X0.I2C_SLV_LEN_LENGTH            = 4;

MPU60X0.I2C_SLV4_RW_BIT               = 7;
MPU60X0.I2C_SLV4_ADDR_BIT             = 6;
MPU60X0.I2C_SLV4_ADDR_LENGTH          = 7;
MPU60X0.I2C_SLV4_EN_BIT               = 7;
MPU60X0.I2C_SLV4_INT_EN_BIT           = 6;
MPU60X0.I2C_SLV4_REG_DIS_BIT          = 5;
MPU60X0.I2C_SLV4_MST_DLY_BIT          = 4;
MPU60X0.I2C_SLV4_MST_DLY_LENGTH       = 5;

MPU60X0.MST_PASS_THROUGH_BIT          = 7;
MPU60X0.MST_I2C_SLV4_DONE_BIT         = 6;
MPU60X0.MST_I2C_LOST_ARB_BIT          = 5;
MPU60X0.MST_I2C_SLV4_NACK_BIT         = 4;
MPU60X0.MST_I2C_SLV3_NACK_BIT         = 3;
MPU60X0.MST_I2C_SLV2_NACK_BIT         = 2;
MPU60X0.MST_I2C_SLV1_NACK_BIT         = 1;
MPU60X0.MST_I2C_SLV0_NACK_BIT         = 0;

MPU60X0.INTCFG_INT_LEVEL_BIT          = 7;
MPU60X0.INTCFG_INT_OPEN_BIT           = 6;
MPU60X0.INTCFG_LATCH_INT_EN_BIT       = 5;
MPU60X0.INTCFG_INT_RD_CLEAR_BIT       = 4;
MPU60X0.INTCFG_FSYNC_INT_LEVEL_BIT    = 3;
MPU60X0.INTCFG_FSYNC_INT_EN_BIT       = 2;
MPU60X0.INTCFG_I2C_BYPASS_EN_BIT      = 1;
MPU60X0.INTCFG_CLKOUT_EN_BIT          = 0;

MPU60X0.INTMODE_ACTIVEHIGH            = 0x00;
MPU60X0.INTMODE_ACTIVELOW             = 0x01;

MPU60X0.INTDRV_PUSHPULL               = 0x00;
MPU60X0.INTDRV_OPENDRAIN              = 0x01;

MPU60X0.INTLATCH_50USPULSE            = 0x00;
MPU60X0.INTLATCH_WAITCLEAR            = 0x01;

MPU60X0.INTCLEAR_STATUSREAD           = 0x00;
MPU60X0.INTCLEAR_ANYREAD              = 0x01;

MPU60X0.INTERRUPT_FF_BIT              = 7;
MPU60X0.INTERRUPT_MOT_BIT             = 6;
MPU60X0.INTERRUPT_ZMOT_BIT            = 5;
MPU60X0.INTERRUPT_FIFO_OFLOW_BIT      = 4;
MPU60X0.INTERRUPT_I2C_MST_INT_BIT     = 3;
MPU60X0.INTERRUPT_PLL_RDY_INT_BIT     = 2;
MPU60X0.INTERRUPT_DMP_INT_BIT         = 1;
MPU60X0.INTERRUPT_DATA_RDY_BIT        = 0;

// TODO= Need to work on DMP related things
MPU60X0.DMPINT_5_BIT                  = 5;
MPU60X0.DMPINT_4_BIT                  = 4;
MPU60X0.DMPINT_3_BIT                  = 3;
MPU60X0.DMPINT_2_BIT                  = 2;
MPU60X0.DMPINT_1_BIT                  = 1;
MPU60X0.DMPINT_0_BIT                  = 0;

MPU60X0.MOTION_MOT_XNEG_BIT           = 7;
MPU60X0.MOTION_MOT_XPOS_BIT           = 6;
MPU60X0.MOTION_MOT_YNEG_BIT           = 5;
MPU60X0.MOTION_MOT_YPOS_BIT           = 4;
MPU60X0.MOTION_MOT_ZNEG_BIT           = 3;
MPU60X0.MOTION_MOT_ZPOS_BIT           = 2;
MPU60X0.MOTION_MOT_ZRMOT_BIT          = 0;

MPU60X0.DELAYCTRL_DELAY_ES_SHADOW_BIT = 7;
MPU60X0.DELAYCTRL_I2C_SLV4_DLY_EN_BIT = 4;
MPU60X0.DELAYCTRL_I2C_SLV3_DLY_EN_BIT = 3;
MPU60X0.DELAYCTRL_I2C_SLV2_DLY_EN_BIT = 2;
MPU60X0.DELAYCTRL_I2C_SLV1_DLY_EN_BIT = 1;
MPU60X0.DELAYCTRL_I2C_SLV0_DLY_EN_BIT = 0;

MPU60X0.PATHRESET_GYRO_RESET_BIT      = 2;
MPU60X0.PATHRESET_ACCEL_RESET_BIT     = 1;
MPU60X0.PATHRESET_TEMP_RESET_BIT      = 0;

MPU60X0.DETECT_ACCEL_ON_DELAY_BIT     = 5;
MPU60X0.DETECT_ACCEL_ON_DELAY_LENGTH  = 2;
MPU60X0.DETECT_FF_COUNT_BIT           = 3;
MPU60X0.DETECT_FF_COUNT_LENGTH        = 2;
MPU60X0.DETECT_MOT_COUNT_BIT          = 1;
MPU60X0.DETECT_MOT_COUNT_LENGTH       = 2;

MPU60X0.DETECT_DECREMENT_RESET        = 0x0;
MPU60X0.DETECT_DECREMENT_1            = 0x1;
MPU60X0.DETECT_DECREMENT_2            = 0x2;
MPU60X0.DETECT_DECREMENT_4            = 0x3;

MPU60X0.USERCTRL_DMP_EN_BIT           = 7;
MPU60X0.USERCTRL_FIFO_EN_BIT          = 6;
MPU60X0.USERCTRL_I2C_MST_EN_BIT       = 5;
MPU60X0.USERCTRL_I2C_IF_DIS_BIT       = 4;
MPU60X0.USERCTRL_DMP_RESET_BIT        = 3;
MPU60X0.USERCTRL_FIFO_RESET_BIT       = 2;
MPU60X0.USERCTRL_I2C_MST_RESET_BIT    = 1;
MPU60X0.USERCTRL_SIG_COND_RESET_BIT   = 0;

MPU60X0.PWR1_DEVICE_RESET_BIT         = 7;
MPU60X0.PWR1_SLEEP_BIT                = 6;
MPU60X0.PWR1_CYCLE_BIT                = 5;
MPU60X0.PWR1_TEMP_DIS_BIT             = 3;
MPU60X0.PWR1_CLKSEL_BIT               = 2;
MPU60X0.PWR1_CLKSEL_LENGTH            = 3;

MPU60X0.CLOCK_INTERNAL                = 0x00;
MPU60X0.CLOCK_PLL_XGYRO               = 0x01;
MPU60X0.CLOCK_PLL_YGYRO               = 0x02;
MPU60X0.CLOCK_PLL_ZGYRO               = 0x03;
MPU60X0.CLOCK_PLL_EXT32K              = 0x04;
MPU60X0.CLOCK_PLL_EXT19M              = 0x05;
MPU60X0.CLOCK_KEEP_RESET              = 0x07;

MPU60X0.PWR2_LP_WAKE_CTRL_BIT         = 7;
MPU60X0.PWR2_LP_WAKE_CTRL_LENGTH      = 2;
MPU60X0.PWR2_STBY_XA_BIT              = 5;
MPU60X0.PWR2_STBY_YA_BIT              = 4;
MPU60X0.PWR2_STBY_ZA_BIT              = 3;
MPU60X0.PWR2_STBY_XG_BIT              = 2;
MPU60X0.PWR2_STBY_YG_BIT              = 1;
MPU60X0.PWR2_STBY_ZG_BIT              = 0;

MPU60X0.WAKE_FREQ_1P25                = 0x0;
MPU60X0.WAKE_FREQ_2P5                 = 0x1;
MPU60X0.WAKE_FREQ_5                   = 0x2;
MPU60X0.WAKE_FREQ_10                  = 0x3;

MPU60X0.BANKSEL_PRFTCH_EN_BIT         = 6;
MPU60X0.BANKSEL_CFG_USER_BANK_BIT     = 5;
MPU60X0.BANKSEL_MEM_SEL_BIT           = 4;
MPU60X0.BANKSEL_MEM_SEL_LENGTH        = 5;

MPU60X0.WHO_AM_I_BIT                  = 6;
MPU60X0.WHO_AM_I_LENGTH               = 6;

MPU60X0.DMP_MEMORY_BANKS              = 8;
MPU60X0.DMP_MEMORY_BANK_SIZE          = 256;
MPU60X0.DMP_MEMORY_CHUNK_SIZE         = 16;
 ...
 */
MPU60X0.prototype.initialize = function() {
    this.wire = new i2c(this.address, {device : '/dev/i2c-1'});
    
    this.setClockSource(MPU60X0.CLOCK_PLL_XGYRO);
    this.setFullScaleGyroRange(MPU60X0.GYRO_FS_250);
    this.setFullScaleAccelRange(MPU60X0.ACCEL_FS_2);
    this.setSleepEnabled(false); // thanks to Jack Elston for pointing this one out!
};

// Wire Functions
MPU60X0.prototype.readByte = function() {
    return this.wire.readByte();
};

MPU60X0.prototype.readBytes = function(func, count) {
    return this.wire.readBytes(func, count);
};

MPU60X0.prototype.writeByte = function(data) {
    return this.wire.writeByte(data);
};

MPU60X0.prototype.writeBytes = function(func, data) {
    return this.wire.writeBytes(func, data);
};

MPU60X0.prototype.bitMask = function(bit, bitLength) {
    return ((1 << bitLength) - 1) << (1 + bit - bitLength);
};

MPU60X0.prototype.readBits = function(func, bit, bitLength) {
    var buf = this.readBytes(func, 1);
    var mask = this.bitMask(bit, bitLength);
    return (buf[0] & mask) >> (1 + bit - bitLength);
};

MPU60X0.prototype.readBit = function(func, bit, bitLength) {
    return this.readBits(func, bit, 1);
};

MPU60X0.prototype.writeBits = function(func, bit, bitLength, value) {
    var oldValue = this.readBytes(func, 1);
    var mask = this.bitMask(bit, bitLength);
    var newValue = oldValue ^ ((oldValue ^ (value << bit)) & mask);
    this.writeBytes(func, [newValue]);
};

MPU60X0.prototype.writeBit = function(func, bit, value) {
 ...
 */
MPU60X0.prototype.testConnection = function() {
...
// */
//MPU60X0.prototype.getAuxVDDIOLevel = function() {
//    return readBit(MPU60X0.RA_YG_OFFS_TC, MPU60X0.TC_PWR_MODE_BIT);
//}
//
///**
...
// */
//MPU60X0.prototype.setAuxVDDIOLevel(level) {
//    return write
 ...
 * @see MPU60X0_GCONFIG_FS_SEL_LENGTH
 */
MPU60X0.prototype.setFullScaleGyroRange = function(range) {
    this.writeBits(MPU60X0.RA_GYRO_CONFIG, MPU60X0.GCONFIG_FS_SEL_BIT, MPU60X0.GCONFIG_FS_SEL_LENGTH, range);
};
 ...
 */
MPU60X0.prototype.setFullScaleAccelRange = function(range) {
    this.writeBits(MPU60X0.RA_ACCEL_CONFIG, MPU60X0.ACONFIG_AFS_SEL_BIT, MPU60X0.ACONFIG_AFS_SEL_LENGTH, range);
};
 ...
 * @see MPU60X0_RA_ACCEL_XOUT_H
 */
MPU60X0.prototype.getMotion6 = function() {
    buffer = this.readBytes(MPU60X0.RA_ACCEL_XOUT_H, 14);
 ...
 * @see MPU60X0_RA_GYRO_XOUT_H
 */
MPU60X0.prototype.getRotation = function() {
   var buffer = this.readBytes(MPU60X0.RA_GYRO_XOUT_H, 6);
   var data = [buffer.readInt16BE(0), buffer.readInt16BE(2), buffer.readInt16BE(4)];  
   return data;
};
 ...
 */
MPU60X0.prototype.getSleepEnabled = function() {
    return this.readBit(MPU60X0.RA_PWR_MGMT_1, MPU60X0.PWR1_SLEEP_BIT);
};
 ...
 * @see MPU60X0_PWR1_SLEEP_BIT
 */
MPU60X0.prototype.setSleepEnabled = function(enabled) {
    this.writeBit(MPU60X0.RA_PWR_MGMT_1, MPU60X0.PWR1_SLEEP_BIT, enabled);
};
 ...
 * @see MPU60X0_PWR1_CLKSEL_LENGTH
 */
MPU60X0.prototype.setClockSource = function(source) {
    this.writeBits(MPU60X0.RA_PWR_MGMT_1, MPU60X0.PWR1_CLKSEL_BIT, MPU60X0.PWR1_CLKSEL_LENGTH, source);
};
 ...
 */
MPU60X0.prototype.getDeviceID = function() {
    return this.readBits(MPU60X0.RA_WHO_AM_I, MPU60X0.WHO_AM_I_BIT, MPU60X0.WHO_AM_I_LENGTH);
};
